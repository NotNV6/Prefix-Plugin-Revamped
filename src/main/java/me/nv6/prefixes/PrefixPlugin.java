 ...
 *
 * Also put my config api in util, but I don't use it in this project whatsoever.
...
public class PrefixPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        new Database(c.getString("database.user"), c.getString("database.password"), c.getString("database.database"), c.getBoolean("database.auth"), c.getString("database.host"), c.getInt("database.port"));
